<template>
  <div class="card p-4">
    <h3 class="text-xl font-bold text-center mb-4">服務方式統計表</h3>
    ...
    <div class="flex align-items-center gap-3 mb-3">
      ...
      <label for="service-method-staff-select" class="font-bold white-space-nowrap"
        >工作人員:</label
      >
      <div class="flex-grow-1">
        <MultiSelect
          inputId="service-method-staff-select"
...
const fetchData = async () => {
  ...
  try {
    const response = await apiHandler.get("/report/general/serviceMethod", {
      params,
    });
