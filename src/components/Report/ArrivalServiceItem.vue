<template>
  <div class="card p-4">
    ...
    <div class="flex align-items-center gap-3 mb-3">
      ...
      <label for="arrival-service-item-staff-select" class="font-bold white-space-nowrap"
        >工作人員:</label
      >
      <div class="flex-grow-1">
        <MultiSelect
          inputId="arrival-service-item-staff-select"
...
const fetchData = async () => {
  ...
  try {
    const response = await apiHandler.get("/report/arrival/serviceItem", {
      params,
    });
